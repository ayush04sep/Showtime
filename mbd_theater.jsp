<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="java.util.Vector" import ="Showtime.TimingMethod" import="Showtime.Time"%>
...
<div id="page-heading"><h1>Theatre Timings</h1></div>
...
<tr>
	...
	<td>
		...
		<!-- start id-form -->
		<form action="addTiming" method="get">
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		<tr>
			<th valign="top">Movie Id:</th>
			<td><input type="text" class="inp-form" name="idmovie"/></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Movie Name:</th>
			<td><input type="text" class="inp-form" name="name" /></td>
		</tr>
        <tr>
			<th valign="top">Time Slot 1:</th>
			<td><input type="text" class="inp-form" name="ts1"/></td>
			<td></td>
		</tr>
		
		<tr>
			<th valign="top">Time Slot 2:</th>
			<td><input type="text" class="inp-form" name="ts2"/></td>
			<td></td>
		</tr>
		
		<tr>
			<th valign="top">Time Slot 3:</th>
			<td><input type="text" class="inp-form" name="ts3"/></td>
			<td></td>
		</tr>
	<tr>
		<th>&nbsp;</th>
