...
<div id="page-heading"><h1>Delete Movies</h1></div>
...
<tr>
	...
	<td>
		...
		<!-- start id-form -->
		<form action="delControl" method="get" enctype="multipart/form-data">
		...
		<div id="related-act-bottom">
			...
			<div class="left"><a href=""><img src="images/forms/icon_edit.gif" width="21" height="21" alt="" /></a></div>
				<div class="right">
					...
					<ul class="greyarrow">
						<li><a href="mbd_theater.jsp">Click here to visit</a></li> 
					</ul>
				</div>
		<div class="clear"></div>
		</div>
